  ...
  humanFacets: [
    {
      ...
      description:
        "A atuação no DevPR reforça troca de repertório, visibilidade técnica e construção de comunidade.",
      icon: "community",
    },
    {
      title: "Escotismo e liderança",
      description:
        "O escotismo trouxe disciplina, mentoria, tomada de decisão e trabalho em equipe em contextos reais.",
      icon: "scouting",
    },
    {
      title: "Operação e atendimento",
      description:
        "GoCoffee fortaleceu liderança sob pressão, organização, treinamento e visão prática da experiência do cliente.",
      icon: "service",
    },
    {
      title: "Comunicação e conversão",
      description:
        "A passagem por tráfego pago ampliou leitura de funil, métricas, testes e comportamento de usuário.",
      icon: "communication",
    },
  ],
} as const;
